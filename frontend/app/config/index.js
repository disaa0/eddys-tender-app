...
const DEV_API_URL =
  process.env.EXPO_PUBLIC_DEV_API_URL || 'http://192.168.0.138:3000:3000/api';

// Production API URL - fallback to production server if env variable is not set
const PROD_API_URL =
  process.env.EXPO_PUBLIC_PROD_API_URL || 'http://192.168.0.138:3000/api';
