...
export default function Checkout() {
  ...
  const [purchaseSuccessfulDialogVisible, setPurchaseSuccessfulDialogVisible] =
    useState(false);
  const [purchaseErrorDialogVisible, setPurchaseErrorDialogVisible] =
    useState(false);
  ...
  const renderProduct = ({ item }) => {
    ...
    const extras = personalizacion.filter(
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Card style={styles.card}>
        ...
        <Card.Content>
          ...
          <List.Item
            ...
            right={() => <Text style={styles.total}>${total.toFixed(2)}</Text>}
          />
        </Card.Content>
      </Card>
      ...
      <ConfirmationDialog
        ...
        onConfirm={() => {
          setPurchaseSuccessfulDialogVisible(false);
          router.push('/orders');
        }}
