...
La aplicación utiliza el sistema de notificaciones push de Expo para enviar alertas a los usuarios sobre actualizaciones de pedidos y otros eventos importantes.

### Configuración para Desarrollo y Producción

1. **Configuración con EAS**:
   - Instala EAS CLI: `npm install -g eas-cli`
   - Inicia sesión en tu cuenta Expo: `eas login`
   - Inicializa EAS en el proyecto: `eas init`

Para más detalles sobre la implementación de notificaciones, consulta la [documentación completa](backend/docs/EXPO_NOTIFICATIONS.md).
